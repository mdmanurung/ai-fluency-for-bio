...
Read the [syllabus data policy](../course-syllabus.qmd#data-policy-required-reading-before-any-exercise-using-real-data) before any exercise with real data. A few clarifications:
